...
addItem(itemsCont1,{'name':'Calendario Azteca',
...
addItem(itemsCont2,{'name':'Quetzalcoatl',
...
addItem(itemsCont3,{'name':'Alcancía de Cerdito',
...
addItem(itemsCont1,{'name':'Juego de 3 tasas',
...
addItem(itemsCont2,{'name':'Catrina',
...
addItem(itemsCont3,{'Olla Tipo Jade':'',
...
addItem(itemsCont1,{'name':'Juego 6 pzas Platos',
...
addItem(itemsCont2,{'name':'Juego Platos y Jarra',
...
addItem(itemsCont3,{'name':'Juego Jarra y tazas',
...
addItem(itemsCont1,{'name':'Jarron para maseta',
    'img':'https://res.cloudinary.com/dozr3yk7l/image/upload/v1663787080/barro%20y%20cer%C3%A1mica/barroyceramica7_fn31qo.jpg',
